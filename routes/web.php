...
// Route::get('/member/dashboard/btc_to_php_conv', 		'MemberDashboardController@btc_to_php_conv');
// Route::get('/member/dashboard/peso_to_aba_conv', 		'MemberDashboardController@peso_to_aba_conv');
// Route::get('/member/dashboard/peso_to_btc_conv', 		'MemberDashboardController@peso_to_btc_conv');
...
Route::get('/member/dashboard/wallet_conversion', 		'MemberDashboardController@wallet_conversion');
