<div class="btc_to_aba_cov_modal">
<div class="modal-header">
  <h5 class="modal-title" id="exampleModalLabel">Convert PHP to BTC </h5>
  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>
<div class="modal-body">
  How much PHP would you like to convert?
  <div class="d-flex flex-row my-3">
    <div class="col">
      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="0" aria-label="0" aria-describedby="basic-addon2" id="pesoToAba">
  ...
  <ul class="list-unstyled">
    <li class="border p-3">
      <div class="d-flex flex-row justify-content-between">
        ...
        <h6 class="my-0">0 PHP</h6>
      </div>
    </li>
    <li class="border p-3">
      <div class="d-flex flex-row justify-content-between">
        <h6 class="my-0 text-muted">Conversion Rate</h6>
        <h6 class="my-0">BTC 1 &boxh; 438 929.04 PHP</h6>
      </div>
    </li>
  </ul>
