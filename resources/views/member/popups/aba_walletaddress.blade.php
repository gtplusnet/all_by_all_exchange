<div class="aba_walletaddress_popup">
		...
		<div class="modal-body px-5">
			...
			<div class="input-group my-3">
				<input type="text" class="form-control text-center" value="3QJmV3qfvL9SuYo34YihAf3sRCW3qSinyC" placeholder="Wallet Address" aria-label="Wallet Address" aria-describedby="basic-addon2" style="border-radius: 0;" id="abaWalletAddressInput">
				...
				<div class="alert alert-warning p-2 my-3">
					<small class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat cumque exercitationem, architecto.</small>
				</div>
